...
# # تدريب نموذج الغابات العشوائية (Random Forest)
...
# تهيئة وتدريب نموذج الغابات العشوائية
# يمكن تعديل المعاملات مثل n_estimators و max_depth لتحسين الأداء
...
# حفظ النموذج المدرب
joblib.dump(model, "/home/ubuntu/src/random_forest_model.pkl")
print("تم حفظ نموذج الغابات العشوائية في: /home/ubuntu/src/random_forest_model.pkl")
